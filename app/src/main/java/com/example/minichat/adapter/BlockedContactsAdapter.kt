...
class BlockedContactsAdapter(private val blockedContactsList:List<BlockedContacts>, private val onClickListener:(BlockedContacts) -> Unit) : RecyclerView.Adapter<BlockedContactsViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BlockedContactsViewHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        return BlockedContactsViewHolder(layoutInflater.inflate(R.layout.item_blocked_contacts, parent, false))
    }
